...
- 日常个人邀请使用可重复取回的长期通用链接，无原 30 天 / 100 次的短期活动限制。
- 原有通用及指定邮箱的一次性链接按原期限继续有效。

### 3.2 团队招聘链接 `team_recruiting`

**入口：** `/invite` 折叠的“特殊邀请设置” → “邀请加入指定团队”；工作台保留历史与停用操作。
