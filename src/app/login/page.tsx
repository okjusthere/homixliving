...
const M = {
  en: {
    signIn: "Sign in",
    title: "Welcome back.",
    lead: "Use Google to sign in. New agents can complete their profile, sign and pay to activate Portal access.",
    ...
    accessDenied: "Google sign-in could not be verified or linked safely. Try again, or contact an administrator if the problem continues.",
  ...
  zh: {
    signIn: "登录",
    title: "欢迎回来。",
    lead: "使用 Google 登录。新经纪人可继续完善资料、签署和付款，完成后自动开通 Portal。",
    ...
    accessDenied: "未能安全验证或关联此 Google 账号。请重试；若仍无法登录，请联系管理员。",
