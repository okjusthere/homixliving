...
assert.equal(
  canCreateTeamRecruitingInvitation({ teamStatus: "inactive" }),
  false,
);
...
assert.equal(
  teamLeaderApplicationEligibility({
    accountStatus: "active",
    agentAgreementStatus: "voided",
    affiliationContractComplete: true,
    plan: "solo_pro",
    licensedCompanySupported: true,
    alreadyLeadsTeam: false,
  }),
  null,
  "Verified complete paper affiliation permits a Team Leader application without rewriting electronic facts",
);
assert.equal(
  teamLeaderApplicationEligibility({
    accountStatus: "active",
    agentAgreementStatus: "completed",
    affiliationContractComplete: false,
    plan: "solo_pro",
    licensedCompanySupported: true,
    alreadyLeadsTeam: false,
  }),
...
assert.equal(
  shouldActivateFormingTeam({
    teamStatus: "forming",
    leaderAgreementStatus: "completed",
    memberAgreementStatus: "voided",
    memberContractComplete: true,
  }),
  true,
);
assert.equal(
  ...
  false,
  "Paper member contract never replaces the Team Leader agreement",
);
