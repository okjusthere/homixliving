...
export async function ensureSchema(sql: Sql) {
  ...
  await run(`
    CREATE TABLE IF NOT EXISTS portal.team_compensation_configs (
      ...
      default_team_split_pct INTEGER NOT NULL DEFAULT 10 CHECK (default_team_split_pct BETWEEN 0 AND 30),
      team_lead_split_pct INTEGER NOT NULL DEFAULT 10 CHECK (team_lead_split_pct BETWEEN 0 AND 40),
